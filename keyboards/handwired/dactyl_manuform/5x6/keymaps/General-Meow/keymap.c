...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   [_COLEMAK] = LAYOUT_5x6(
       ...
       KC_TAB ,TD(TD_Q),TD(TD_W),TD(TD_F),TD(TD_P),TD(TD_B),           TD(TD_J),TD(TD_L),TD(TD_U),TD(TD_Y),KC_SCLN,KC_NUHS,
       MOUSE  ,TD(TD_A),TD(TD_R),TD(TD_S),TD(TD_T),TD(TD_G),           TD(TD_M),TD(TD_N),TD(TD_E),  KC_I  ,   KC_O,TD(TD_QUO),
       KC_LSFT,TD(TD_Z),TD(TD_X),TD(TD_C),TD(TD_D),TD(TD_V),           TD(TD_K),TD(TD_H),KC_COMM,  KC_DOT ,KC_SLSH,KC_BSLASH,
    ...
    [_COLEWIN] = LAYOUT_5x6(
        KC_ESC ,   KC_1  ,   KC_2  ,   KC_3  ,   KC_4  ,   KC_5  ,              KC_6  ,   KC_7  ,   KC_8  ,   KC_9  , KC_0  , KC_BSPC,
        KC_TAB ,TD(TD_WQ),TD(TD_WW),TD(TD_WF),TD(TD_WP),TD(TD_WB),           TD(TD_WJ),TD(TD_WL),TD(TD_WU),TD(TD_WY),KC_SCLN, KC_MINS,
        MOUSE  ,TD(TD_WA),TD(TD_WR),TD(TD_WS),TD(TD_WT),TD(TD_WG),           TD(TD_WM),TD(TD_WN),TD(TD_WE),   KC_I  ,   KC_O,TD(TD_WQUO),
        KC_LSFT,TD(TD_WZ),TD(TD_WX),TD(TD_WC),TD(TD_WD),TD(TD_WV),           TD(TD_WK),TD(TD_WH),KC_COMM,    KC_DOT ,KC_SLSH,KC_BSLASH,
                         KC_LALT, KC_LCTL,                                                       KC_RCTL, KC_RALT,
                                         MODWIN, KC_LSFT,                        KC_SPC, MODWIN,
                                        KC_LCTL, KC_BSPC,                        KC_ENT,MOUSEWIN,
    ...
    [_MOD] = LAYOUT_5x6(
          KC_BSLS, KC_F1 ,       KC_F2 ,      KC_F3 ,       KC_F4 ,    KC_F5 ,                        KC_F6  ,    KC_F7 ,    KC_F8 ,   KC_F9 ,KC_F10 , KC_F11,
