...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_5x6(
        ...
        MOUSE  , KC_A  , KC_R  , KC_S  , KC_T  , KC_G  ,                         KC_M  , KC_N  , KC_E  , KC_I  ,   KC_O,KC_QUOTE,
        KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_D  , KC_V  ,                         KC_K  , KC_H  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                         KC_LALT, KC_LCMD,                                                       KC_RCMD, KC_RALT,
                                          RAISE, KC_LSFT,                        KC_SPC, LOWER,
                                        KC_LCTL, KC_BSPC,                        KC_ENT,  KC_ENT,
    ...
    [_RAISE] = LAYOUT_5x6(
          ...
          _______,_______,_______,_______,_______,KC_LBRC,                        KC_PGUP, KC_HOME,   KC_UP,   KC_END,KC_SLCK, KC_F12,
          _______,KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT,KC_LPRN,                        KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT,_______,KC_VOLU,
